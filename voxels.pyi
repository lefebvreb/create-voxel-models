...
class Model:
    ...
    @property
    def palette(self, /) -> Palette: ...
    def put(self, /, material: Material |None, a: tuple[int, int, int]) -> None: ...
    def render(self, /, angles: Sequence[CameraAngle]) -> RenderOutput: ...
    def spheroid(self, /, material: Material |None, center: tuple[int, int, int], r1: int, r2: int |None = None, r3: int |None = None) -> None: ...
