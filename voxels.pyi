...
class Model:
    ...
    def render(self, /, angles: Sequence[CameraAngle], *, background: tuple[int, int, int] |None = None) -> RenderOutput: ...
...
class Scene:
    ...
    def render(self, /, angles: Sequence[CameraAngle], *, times: Sequence[float] = ..., animation: str |None = None, include: Sequence[str] |None = None, exclude: Sequence[str] |None = None, background: tuple[int, int, int] |None = None) -> RenderOutput: ...
...
@final
class Volume:
    def __new__(cls, /, color: tuple[int, int, int], distance: float, *, thickness: float = 1.0) -> Volume: ...
    @property
